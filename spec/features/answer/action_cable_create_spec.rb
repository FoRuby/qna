...
feature 'When user creates a new answer,
  ...
  context 'mulitple sessions', js: true do
    scenario 'answer appears for all users who are on the same question page' do
    ...
    scenario 'answer does not appears for user who are not on the same question page' do
      Capybara.using_session('user') do
        login(user)
        visit question_path(question1)
      end
